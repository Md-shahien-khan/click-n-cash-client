...
const Navbar = () => {
    const navOptions = <>
        ...
        <li><Link to='/about' className="text-xl font-semibold text-teal-200 hover:text-teal-400 transition duration-200">About</Link></li>
        <li><Link to='/services' className="text-xl font-semibold text-teal-200 hover:text-teal-400 transition duration-200">Services</Link></li>
        <li><Link to='/join-developer' className="text-xl font-semibold text-teal-200 hover:text-teal-400 transition duration-200">Join as Developer</Link></li>
    </>;
